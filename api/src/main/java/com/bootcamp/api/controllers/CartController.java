...
public class CartController {
    ...
    @RequestMapping(value = "/{idproduct}" , method = RequestMethod.POST , produces = "application/jason")
    ...
    @RequestMapping(value = "/{idproduct}", method = RequestMethod.PUT , produces = "application/jason")
    ...
    @RequestMapping(value = "/{idproduct}" ,  method = RequestMethod.DELETE, produces = "application/jason")
    ...
    @RequestMapping(method = RequestMethod.DELETE, produces = "application/jason")
